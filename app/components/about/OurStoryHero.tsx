        ...
        <MaxWidth className="h-full flex items-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-white/75 text-xs sm:text-sm md:text-base max-w-md leading-relaxed">
              From humble beginnings to becoming a trusted real estate developer,
              Sunvia Properties is shaping modern living spaces in Dhaka with integrity,
              innovation, and care.
            </p>

            {/* Trust line */}
            <p className="mt-4 text-white/40 text-[11px] sm:text-xs">
              RAJUK Approved • Sunvia Group • Dhaka, Bangladesh
            </p>
